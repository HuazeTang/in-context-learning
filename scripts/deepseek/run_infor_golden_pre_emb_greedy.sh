...
mkdir -p log
python3 main.py evaluation=infor_golden_in_context_pre_emb_greedy dataset=mmlu_pre_emb_deepseek_qwen3 model=no_model model.config.layer_num=32 | tee "log/${experiment_name}.txt"
...
python3 main.py evaluation=infor_golden_in_context_pre_emb_greedy dataset=mmlu_pre_emb_deepseek_qwen3_float32 model=no_model model.config.layer_num=32 | tee "log/${experiment_name}.txt"
