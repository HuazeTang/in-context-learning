...
run_experiment() {
    ...
    python3 main.py evaluation=infor_random_in_context_pre_emb dataset=mmlu_pre_emb_deepseek_qwen3 model=no_model model.config.layer_num=32 dataset.config.dataset_path=${dataset_path_arg} | tee "log/${experiment_name}.txt"
