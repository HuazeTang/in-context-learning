...
for repeat_time in 1 2 3 4 5; do
    ...
    python3 main.py evaluation=infor_random_in_context_pre_emb dataset=mmlu_pre_emb_llama3 model=no_model model.config.layer_num=32 | tee "log/${experiment_name}.txt"
...
for repeat_time in 1 2 3 4 5; do
    ...
    python3 main.py evaluation=infor_random_in_context_pre_emb dataset=mmlu_pre_emb_llama3_float32 model=no_model model.config.layer_num=32 | tee "log/${experiment_name}.txt"
