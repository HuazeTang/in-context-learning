...
for subject in "${subjects[@]}"; do
    ...
    python3 main.py evaluation=emb_gen model=qwen model.config.torch_dtype=$torch_dtype dataset.config.subjects="[$subject]" evaluation.config.pool_method=${pool_method} | tee "log/${experiment_name}.txt"
